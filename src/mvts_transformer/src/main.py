...
def main(config):
    ...
    if config['inference_mode']:
        ...
        test_data = data_class(config['data_dir'])
        test_indices = test_data.feature_df.index
        ...
        evaluate_test = runner_class(model, test_loader, device, loss_module,
                                        print_interval=config['print_interval'], console=config['console'])
        evaluate_test.inference()
        return
